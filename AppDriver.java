...
public class AppDriver {
		...
		while (true) {
			...
			case 1:
				...
				while (todaysTask == true) {
					...
					getTodaysListMenu();
					System.out.println("\nPlease Enter Your Choice :");
					int todaysTaskChoice = getChoice(1, 5);
			...
			case 3:
				...
				while (removeList) {
					...
					System.out.println("\nPlease Enter Your Choice :");
					int RemoveListsChoice = getChoice(1, 3);
	...
	public static void getTodaysListMenu() {
		...
		System.out.println("| |             Press (4) To Save Todays Task List In Month file      | |");
		System.out.println("| |             Press (5) Main Menu                                   | |");
		System.out.println("| |                                                                   | |");
		System.out.println("*************************************************************************");
	}
	...
	public static LocalTime getLocalTime() throws IOException {
		...
		System.out.println("| |                  Note: Enter \"C\" to Cancel                        | |");
		System.out.println("| |                                                                   | |");
		System.out.println("*************************************************************************");
	...
	public static LocalDate getLocalDate() throws IOException {
		...
		System.out.println("\n*************************************************************************");
		System.out.println("| |                                                                   | |");
		System.out.println("| |               Note: Please Enter Date in (DD/MM/YYYY)             | |");
		System.out.println("| |               Note: Enter \"C\" to Cancel                           | |");
		System.out.println("| |                                                                   | |");
		System.out.println("*************************************************************************");
		int DateDay = 0;
